...
{
        public  class Doors : Events.Script
    {
        ...
        private static Colshape clothesmarket = null;
        ...
        public Doors()
        {
            ...
            clothesmarket = new SphereColshape(new Vector3(82.38156f, -1390.752f, 29.52609f), 5.0f, 4294967295);
            // Bind the event for the colshapes above
            OnPlayerEnterColshape += OnPlayerEnterColshapeEvent;

            //Object.SetStateOfClosestDoorOfType(1005, 469.9679f, -1014.452f, 26.53623f, false, 0.0f, false);
            //Object.SetStateOfClosestDoorOfType(1006, 469.9679f, -1014.452f, 26.53623f, false, 0.0f, false);
            //Object.SetStateOfClosestDoorOfType(1007, 469.9679f, -1014.452f, 26.53623f, false, 0.0f, false);
            //Object.SetStateOfClosestDoorOfType(Misc.GetHashKey("v_ilev_ph_cellgate"), 461.8065f, -994.4086f, 25.06443f, false, 0.0f, false);
            //Object.SetStateOfClosestDoorOfType(Misc.GetHashKey("v_ilev_ph_cellgate"), 461.8065f, -997.6583f, 25.06443f, false, 0.0f, false);
            //Object.SetStateOfClosestDoorOfType(Misc.GetHashKey("v_ilev_ph_cellgate"), 461.8065f, -1001.302f, 25.06443f, false, 0.0f, false);
        ...
        public static void OnPlayerEnterColshapeEvent(Colshape colshape, CancelEventArgs cancel)
        {
            ...
            if (colshape == clothesmarket)
            {
                
                Object.SetStateOfClosestDoorOfType(Misc.GetHashKey("v_ilev_cs_door01"), 82.38156f, -1392.752f, 29.52609f, false, 0.0f, false);
                Object.SetStateOfClosestDoorOfType(Misc.GetHashKey("v_ilev_cs_door01_r"), 82.31860f, -1390.475f, 29.5261f, false, 0.0f, false);
                return;
            }
        }
    }
